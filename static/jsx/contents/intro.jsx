    ...
    <$FMD>
      ...
      <Card className="pad-10px">
        ...
        <$CardDef title="Interpolación Lineal" elevation={0}>
          ...
          proporcionalmente. Los diseños responsivos harán transiciones suaves y
          escalado preciso.
        </$CardDef>
        <$CardDef title="Condiciones Dinámicas" elevation={0}>
          Define comportamientos específicos mediante condiciones dinámicas como
          "menor que", "mayor que" y "entre", aplicadas al ancho o a la altura
          de la ventana.
          <p>
